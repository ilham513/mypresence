...
<body>
  ...
  <main id="main" class="main">
    ...
    <section class="section dashboard">
		...
		<div class="card">
            <div class="card-body">
              <h5 class="card-title">Mengubah Pelajaran</h5>

              <!-- General Form Elements -->
              <form action="<?=site_url('admin/edit_pelajaran_go')?>" method="post">
                <div class="row mb-3 d-none">
                  <div class="col-sm-10">
                    <input name="id_pelajaran" type="hidden" value="<?=$obj_pelajaran->id_pelajaran?>" class="form-control">
                  </div>
                </div>
				
                <div class="row mb-3">
                  <label for="inputText" class="col-sm-2 col-form-label">Nama Pelajaran</label>
                  <div class="col-sm-10">
                    <input name="nama_pelajaran" type="text" value="<?=$obj_pelajaran->nama_pelajaran?>" class="form-control">
                  </div>
                </div>
                ...
                <div class="row mb-3">
                  ...
                  <div class="col-sm-10">
                    <input name="nama_guru" type="text" value="<?=$obj_pelajaran->nama_guru?>" class="form-control">
                  </div>
                </div>
