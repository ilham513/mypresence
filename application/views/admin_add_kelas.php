...
<body>
  ...
  <main id="main" class="main">
    ...
    <section class="section dashboard">
		...
		<div class="card">
            <div class="card-body">
              <h5 class="card-title">Menambah Kelas</h5>

              <!-- General Form Elements -->
              <form action="<?=site_url('admin/add_kelas_go')?>" method="post">
                <div class="row mb-3">
                ...
                <div class="row mb-3">
                  <label for="inputText" class="col-sm-2 col-form-label">Jumlah Murid</label>
                  <div class="col-sm-10">
                    <input name="jumlah_murid" type="number" class="form-control">
                  </div>
                </div>
