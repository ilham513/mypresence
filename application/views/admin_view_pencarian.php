...
<body>
  ...
  <main id="main" class="main">
    ...
    <div class="pagetitle">
      <h1>Algorima Pencarian</h1>
      <nav>
        <ol class="breadcrumb">
          <li class="breadcrumb-item"><a href="<?=site_url('admin')?>">Home</a></li>
          <li class="breadcrumb-item active">Algorima Pencarian</li>
        </ol>
      </nav>
    </div><!-- End Page Title -->
              ...
              <div class="card recent-sales overflow-auto">
                ...
                <div class="card-body">
					<div class="d-flex justify-content-between">
						<h5 class="card-title">Algorima Pencarian Sequential Search</h5>
					</div>	

					<form id="form-id" action="<?= site_url('admin/view_pencarian_go') ?>" method="post">					
					<div class="input-group mb-3">
					  <input name="nama_siswa" type="text" class="form-control" placeholder="Tuliskan nama murid..." aria-label="Recipient's username" aria-describedby="basic-addon2">
					  <span id="your-id" class="input-group-text" id="basic-addon2"><i class="bi bi-search"></i></span>
					</div>
					</form>
