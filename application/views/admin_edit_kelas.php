...
<body>
  ...
  <main id="main" class="main">
    ...
    <section class="section dashboard">
		...
		<div class="card">
            <div class="card-body">
              <h5 class="card-title">Mengubah Kelas</h5>

              <!-- General Form Elements -->
              <form action="<?=site_url('admin/edit_kelas_go')?>" method="post">
                <div class="row mb-3 d-none">
                  <div class="col-sm-10">
                    <input name="id_kelas" type="hidden" value="<?=$obj_kelas->id_kelas?>" class="form-control">
                  </div>
                </div>
                ...
                <div class="row mb-3">
                  ...
                  <div class="col-sm-10">
                    <input name="nama_kelas" type="text" value="<?=$obj_kelas->nama_kelas?>" class="form-control">
                  </div>
                </div>
                ...
                <div class="row mb-3">
                  ...
                  <div class="col-sm-10">
                    <input name="jumlah_murid" type="number" value="<?=$obj_kelas->jumlah_murid?>" class="form-control">
                  </div>
                </div>
