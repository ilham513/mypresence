...
<body>
  ...
  <main id="main" class="main">
    ...
    <section class="section dashboard">
		...
		<div class="card">
            <div class="card-body">
              <h5 class="card-title">Menambah Pelajaran</h5>

              <!-- General Form Elements -->
              <form action="<?=site_url('admin/add_pelajaran_go')?>" method="post">
                <div class="row mb-3">
                  <label for="inputText" class="col-sm-2 col-form-label">Nama Pelajaran</label>
                  <div class="col-sm-10">
                    <input name="nama_pelajaran" type="text" class="form-control">
                  </div>
                </div>
